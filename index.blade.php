        ...
        <header class="header">
            ...
            <nav>
                <div class="recherche">
                    ...
                    @if(Auth::user()!=null)
                        <h1><a href="/user/{{Auth::user()->id}}">Voir compte</a></h1>
                    @else
                        <h1><a href="/login">Se connecter</a></h1>
                    @endif
                    <form method="post">
                        <style>
                            .recherche form{
        ...
        <div class="sliders">
            ...
            <div class="first_slider">
                @foreach($commentaireRecent as $com)
                    <div><img src={{$com->urlImage}}><div class="slider_hover"><a href="/series/{{$com->id}}">Voir</a></div></div>
                @endforeach

            </div>

            <h3><a href="/series">Tout voir</a></h3>
                    ...
                    <div class="second_slider">
                        ...
                        @foreach($serieRecente as $serie)
                            <div><img src={{$serie->urlImage}}><div class="slider_hover"><a href="/series/{{$serie->id}}">Voir</a></div></div>
                        @endforeach
                    ...
                    <h3><a href="/series">Tout voir</a></h3>
                            ...
                            <div class="third_slider">
                                ...
                                <div><a href="https://www.youtube.com/watch?v=zIVQlObaLIs&feature=youtu.be&fbclid=IwAR0IkQ6pxgVhj2XnWtaFaubqj_hAEDMZFJlQMEVPujPPnMtFpbzsG8QvZZ8"><img src="{{url("img/thecrowart-02.png")}}" width="100%"> </a></div>
